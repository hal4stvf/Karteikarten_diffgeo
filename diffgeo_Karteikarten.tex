...
\newcommand{\nonameyet}[4]{\begin{karte}[{\small #1} ({#2})]{{#3}} #4\end{karte}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\\
\fl{Dann heißt $M$ topologische Mannigfaltikeit der Dimension $n$, falls es zu
...
\fl{$(U,\varphi)$ nennt man eine \texttt{Karte} von $M$.}
}
{}
...
\\
\fl{Dann heißt $\mathcal{A}$ ein  \texttt{$(C^\infty)$-Atlas}, falls folgendes gilt:}
\begin{enumerate}[1.]
...
%\footnotesize
\par (Die Abbildungen $\varphi_\beta \circ \varphi_\alpha^{-1}$ heißen 
...
% 1.3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\kommentar{\footnotesize 1.3 Differenzierbare Abbildungen}
\nonameyet
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\kommentar{\tiny Resultate aus der Analysis}
\nonameyet
...
(p,v) \mapsto 
(
%\overbrace{\varphi(\pi(p,v))}^
%{\parbox{4em}{$\varphi(p) = (x_1(p),\dots,x_n(p))$}}
\varphi(\pi(p,v)),
v(x_1),\dots,v(x_n))$
